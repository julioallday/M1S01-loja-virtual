  ...
  if (produtoAtualTemp != undefined) {
    ...
    sobre_el.innerHTML = `<div class="produto">
                    ...
                    <div class="card-elements">
                        <h4 class="title">${produtoAtualTemp.title}</h4>
                        <p class="description" >${
                          produtoAtualTemp.description
                        }</p>
                        <p class="price">${produtoAtualTemp.price}$</p>
                        </div>
                    </div>
                    <a id="adicionar-carrinho" class="comprar" >Adicionar ao carrinho</a>
                    </div>`;
  }
}
